...
namespace Simplex
{
	...
	class MyOctant
	{
		...
		static uint m_uIdealEntityCount; //will tell how many ideal Entities the entire octree should contain
	...
	public:
		...
		*/
		...
		/*
		USAGE: Displays all of the MyOctant volumes
		ARGUMENTS:
		- vector3 a_v3Color = REYELLOW -> Color of the volume to display.
		OUTPUT: ---
		*/
		...
		*/
		...
		/*
		USAGE: Assigns the appropriate to the entities in the dimension
		ARGUMENTS: ---
		OUTPUT: ---
		*/
